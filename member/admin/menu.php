<ul class="Selection">
  ...
  <!-- <li><a href="list-upload.php"><div class="Tab<?php if($menu_active=='upload'){ ?>-Active<?php } ?>">提出ファイル一覧</div></a></li> -->
  <li><a href="list-comment.php"><div class="Tab<?php if($menu_active=='comment'){ ?>-Active<?php } ?>">コメント一覧</div></a></li>
  <li><a href="list-contact.php"><div class="Tab<?php if($menu_active=='contact'){ ?>-Active<?php } ?>">お問い合わせ一覧</div></a></li>
  <li><a href="logout.php"><div class="Tab">ログアウト</div></a></li>
</ul>
